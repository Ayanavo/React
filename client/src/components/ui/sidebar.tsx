...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  return <div ref={ref} data-sidebar="group" className={cn("relative flex w-full min-w-0 flex-col p-2 scroll-smooth overflow-scroll [scrollbar-width:none] [&::-webkit-scrollbar]:hidden", className)} {...props} />;
});

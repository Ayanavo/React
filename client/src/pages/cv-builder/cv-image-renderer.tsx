...
const CvImageRenderer = ({ element, readonly = false }: { element: CVElement; readonly?: boolean }) => {
  ...
  const wrapperStyle: CSSProperties =
    element.properties?.textAlign === "center" ? { justifyContent: "center" }
    : element.properties?.textAlign === "end" ? { justifyContent: "flex-end" }
  ...
  return (
    <div
      ...
      <div className="flex w-full" style={wrapperStyle}>
        {/* BORDER */}
        <div style={borderStyle} className={isSelected ? "ring-2" : ""}>
          {/* PADDING */}

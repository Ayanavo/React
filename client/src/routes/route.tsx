...
const STATIC_ROUTES: RouteConfig[] = [
  { path: "/login", element: <GuestOnly><LoginComponent /></GuestOnly> },
  { path: "/register", element: <GuestOnly><RegistrationComponent /></GuestOnly> },
  { path: "/forgot-password", element: <GuestOnly><ForgotPasswordComponent /></GuestOnly> },
];

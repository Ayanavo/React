...
import { createConferenceLinkHandler } from "../controllers/conferenceController.js";
import { authenticateToken } from "../controllers/userController.js";

const router = Router();

router.get("/", authenticateToken as any, getActivities);
router.post("/conference-link", authenticateToken as any, createConferenceLinkHandler as any);
